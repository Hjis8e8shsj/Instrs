...
<body style='font-family: Yatra One;'>
 ...
 <center>
     <?php
error_reporting(0);
echo "<br><br><center><h1>Programer <span></span></h1></center>        <br><center><h1>  - @wg_9a<span></span></h1></center><br>";
...
<div class="container p-2 text-center">
			<button onclick="location.href='https://t.me/wg_9a'" class="btn btn-primary rounded-circle icon-btn"><i class="fa fa-telegram"></i></button>
			<button onclick="location.href='https://www.instagram.com/programer_vb_net/ '" class="btn btn-primary rounded-circle icon-btn"><i class="fa fa-instagram"></i></button>
			<p class="text-muted p-5"> By HSWN </p>
		</div>
